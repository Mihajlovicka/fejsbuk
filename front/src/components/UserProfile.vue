        ...
        <div class="komentari">
          ...
          <div class="container justify-content-center mt-5 border-left border-right">
            <div class="d-flex justify-content-center pt-3 pb-2" v-if="logged_username != ''">
              <input type="text" name="text" placeholder="+ nov komentar" class="form-control addtxt" v-model="newCommentText">
...
export default {
  ...
  methods: {
    ...
    newComment(post){
      axios.post('/updatePost',{id:post.id,text:this.newCommentText}).then(() => {
