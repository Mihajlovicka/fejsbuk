                  ...
                  <tr class="inner-box" v-for="user in filteredOffers" :key="user">
                    ...
                    <td>
                      <div class="event-wrap">
                        <h3><router-link to="/userProfile" user="user">{{ user.name }} {{ user.surname }}</router-link></h3>
                        <div class="meta">
                          <div>{{ user.sex }}
                          </div>
                          <div>
                    ...
                    <td>
                      <div class="primary-btn">
                        <a class="btn btn-primary" href="#">Dodaj prijatelja</a>
                      </div>
                    </td>
                  </tr>
                  </tbody>
...
export default {
  ...
  created() {
    ...
    axios.get("/getAllUsers").then(resp => {
      this.users = resp.data;
      this.getPictures();
    })
  },
