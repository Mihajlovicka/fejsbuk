            ...
            <div class="tab-pane fade active show" id="home" role="tabpanel">
              <div class="table-responsive">
                <table class="table">
                  ...
                  <tbody>
                  <tr v-if="filteredOffers.length==0 && personalProfile" align="center">
                    <th>Trenutno nemate prijatelje, ali ne brinite pojavice se kada za to dodje vreme. Sada Vam nisu potrebni, dovoljni ste sami sebi! 😎</th>
                  </tr>

                  <tr v-if="filteredOffers.length==0 && !personalProfile" align="center">
                    <th>Korisnik/ca trenutno nema prijatelje, ali ne brinite pojavice se kada za to dodje vreme. Sada mu/joj nisu potrebni, dovoljan/na je sam/a sebi! 😎 Ukoliko zelite posaljite mu/joj zahtev jer mozda bas Vas ceka! 🤗</th>
                  </tr>
                  <tr class="inner-box" v-for="user in filteredOffers" :key="user.username">
                    ...
                    <td>
                      ...
                      <div v-if="loggedIn && personalProfile" class="primary-btn col-12">
                        <button class="btn btn-icon btn-outline-danger" style="width:100%; margin-top:5px;" @click="removeFriend(user);">
...
export default {
  ...
  methods:{
    ...
    removeFriend(user){
        ...
        axios.post('/removeFriend', user).then(resp => {
